package com.aborteddevelopers.game_pouch;
...
import com.aborteddevelopers.game_pouch.Adapter.MyItemGroupAdapter;
import com.aborteddevelopers.game_pouch.Interface.IFirebaseLoadListener;
...
public class MainActivity extends AppCompatActivity implements IFirebaseLoadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        my_recycler_view = (RecyclerView)findViewById(R.id.my_recyler_view);
